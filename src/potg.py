...
def getLocations(all_lines):
	...
	for line in all_lines:
		...
		if round_in_progress:
			(descriptor, line_num_bool, new_rip) = getProgressDescriptor(line, world_trigger, round_in_progress, low, high)
...
'''  '''
def getProgressDescriptor(line, world_trigger, round_in_progress, low, high):	#getLocations helper function
	points_bool = False
	descriptor = ''
	try:
